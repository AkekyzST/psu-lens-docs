...
The top of the form shows the course details (course code, name, section, credits), the progress bar and a back button.

## 1. Course/Module Assessment

<figure><img src="../../.gitbook/assets/v2-student-eval-course.png" alt=""><figcaption><p>The course/module assessment with the progress rail alongside</p></figcaption></figure>

This part is your reflection on how well the course/module worked. It has a set of topics to answer, plus a comment box at the end in case you want to say more in your own words.
...
The **"Submit evaluation"** button sits in the top-right corner of the header bar on the "Review & submit" tab (the same place as "Save draft and next" on the earlier parts). Pressing it opens a confirmation dialog.

{% hint style="warning" %}
Once you confirm, **your answers can no longer be changed**. Please review them before you confirm.
{% endhint %}

{% hint style="info" %}
If you have answered everything but not pressed submit, and you try to leave the page, the system warns you first — an evaluation isn't counted until it is submitted.
{% endhint %}
