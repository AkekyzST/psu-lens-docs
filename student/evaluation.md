...
* กด **บันทึกร่าง** เพื่อเก็บคำตอบไว้ก่อน (ยังไม่ส่ง) แล้วกลับมาทำต่อเมื่อไรก็ได้
* ปุ่ม **"บันทึกร่างและไปต่อ"** ช่วยบันทึกคำตอบและพาไปส่วนถัดไปในคลิกเดียว
...
ปุ่ม **"ส่งแบบประเมิน"** อยู่มุมบนขวาของหน้าจอ ถัดจากปุ่มบันทึกร่าง กดแล้วจะมีหน้าต่างให้ยืนยันอีกครั้ง
